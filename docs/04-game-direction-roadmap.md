...
本輪預計先開發新主題「價值觀與未來」，並把「靈魂共振」放入卡面或首頁描述，作為該主題的情緒記憶點。後續再逐步解除卡牌數量固定 20 張、移除既有四主題 intimate 區別，最後新增 Mix 牌堆。
...
現況中，多份規格、測試與文件仍預設每主題最多 20 張。若新主題採 25 張，或未來各主題可逐步擴充，就需要把「每主題固定 20 張」改成「每主題至少有可遊玩的卡牌數，沒有硬性上限」。
